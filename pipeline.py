...
class FlickdPipeline:
    def __init__(self, videos_dir, frames_dir, transcripts_dir):
...
if __name__ == "__main__":
    pipeline = FlickdPipeline(videos_dir='data/videos', frames_dir='data/frames', transcripts_dir='data/transcripts')
    pipeline.run()